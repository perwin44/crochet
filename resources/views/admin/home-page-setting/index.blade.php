                      ...
                      <div class="row">
                        <div class="col-2">
                          <div class="list-group" id="list-tab" role="tablist">
                            <a class="list-group-item list-group-item-action active" id="list-profile-list" data-toggle="list" href="#list-profile" role="tab">Trending Products Section</a>
                            <a class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list" href="#list-messages" role="tab">Best Selling Products Section</a>
                        ...
                        <div class="col-10">
                          <div class="tab-content" id="nav-tabContent">
                            ...
                            @include('admin.home-page-setting.sections.trending-products-section')

                             @include('admin.home-page-setting.sections.best-selling-section')
