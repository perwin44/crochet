    ...
    <div class="row">
        <div class="col-xl-12 m-auto">
            <div class="wsus__payment_area">
                <form action="{{route('stripe.payment')}}" method="POST" id="checkout-form">
                    @csrf
                    <input type="hidden" name="stripe_token" id="stripe-token-id">
                    <div id="card-element" class="form-control"></div>
                    <br>
                    <button class="btn btn-primary" class="nav-link common_btn" id="pay-btn" onclick="createToken()" type="button">Pay with Credit Card</button>
                </form>
            </div>
        </div>
    </div>
