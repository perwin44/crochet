                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-7">
                        <div class="wsus__check_form">
                            ...
                            <a href="javascript:;" style="margin-left:auto;" class="btn btn-outline-info" class="common_btn" data-bs-toggle="modal" data-bs-target="#exampleModal">add
                                new address</a>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-5">
                        <div class="wsus__order_details" id="sticky_sidebar">
                            ...
                            <a href="" class="btn btn-outline-danger"  id="submitCheckoutForm" class="common_btn">Place Order</a>
                        </div>
                    </div>
                </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body p-0">
                        <div class="wsus__check_form p-3">
                            <form action="{{route('checkout.address.create')}}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
    ...
    $(document).ready(function(){
        ...
        $('#submitCheckoutForm').on('click', function(e){
            ...
            if($('#shipping_method_id').val() == ""){
                ...
                $.ajax({
                    url: "{{route('checkout.form-submit')}}",
                    method: 'POST',
