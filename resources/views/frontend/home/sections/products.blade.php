@php
    $trendingProducts = json_decode($trendingProducts->value,true);
            ...
            <div class="tabs-header d-flex justify-content-between border-bottom my-5">
              ...
              <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                  ...
                  $products = [];
                  @endphp
              @foreach ($trendingProducts as $key => $trendingProduct)
              @php
                  $lastKey = [];

                  foreach($trendingProduct as $key => $category){
                      if($category === null ){
                          break;
                      }
              ...
              @endphp
                     <a href="#" class="nav-link text-uppercase fs-6" id="-tab" data-bs-toggle="tab" data-bs-target="#">{{ $category->name }}</a> 
                    @endforeach
                ...
                <div class="product-grid row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-5">
                  ...
                  <div class="col">
                    <div class="product-item " >
                      ...
                      <span class="badge bg-success position-absolute m-3  @if(!$product->offer_price) d-none   @endif ">-{{ checkDiscount($product) }} {{ $product->offer_price }}% </span>                
                  
                      <a href="#" class="btn-wishlist"><svg width="24" height="24"><use xlink:href="#heart"></use></svg></a>
                      <figure>
                        <a href="index.html" title="Product Title">
                          <img src="{{asset($product->image)}}"  class="tab-image">
                        </a>
                      </figure>
                      <h3>{{($product->name)}}</h3>
                      <span class="qty">{{($product->qty)}} Unit</span><span class="rating"><svg width="24" height="24" class="text-primary"><use xlink:href="#star-solid"></use></svg> 4.5</span>
